...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LCTL(LSFT(KC_C)),LCTL(LSFT(KC_V)),  KC_MEH, KC_LGUI,KC_LALT,
																																																		 TG(SYMB), TG(MDIA),
                                                              KC_PGUP,
        ...
        // right hand
             ...
             MO(SYMB),	KC_N,	  KC_M,	    KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
																															KC_LEFT,  KC_DOWN,  KC_UP,  KC_RIGHT,	LCTL(KC_A),
             LGUI(KC_L),KC_RCTL,
             KC_PGDN,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_ASTR, KC_TRNS,
                         KC_0,	 KC_DOT,  KC_EQL,  KC_BSLS,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
